      ...
      <section className="section-spacing">
        <div className="container-grid">
          <div
            ...
            data-src="https://widgets.bokun.io/online-sales/4bc9f458-4ebc-42a2-b3b4-1780533df977/experience-list/105783"
            style={{ minHeight: "700px", width: "100%", background: "hsl(var(--secondary))" }}
          />
        </div>
      </section>
    </PageLayout>
