...
import { CalendarDays, User, Heart, FileText, LogOut, Home, Wifi, MapPin, BookOpen, Headset } from "lucide-react";
...
const navItems = [
  ...
  { to: "/dashboard/consultancy", icon: Headset, label: "Travel Assistant", end: false },
