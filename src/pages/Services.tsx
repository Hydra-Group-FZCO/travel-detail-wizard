...
const services = [
  {
    ...
    desc: "End-to-end custom software solutions with deep expertise in the travel and hospitality industry. We build booking engines, property management systems, visa platforms, and enterprise applications — all scalable, secure, and high-performance. We're currently developing a next-generation PMS for a major international hotel chain (under NDA).",
    process: ["Discovery", "Design", "Development", "Testing", "Deployment", "Support"],
    useCases: ["Travel & Hospitality Platforms", "PMS Systems", "Booking Engines", "SaaS Platforms", "E-commerce", "API Development"],
